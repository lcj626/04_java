...
public class Application01 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        * 코드를 컴파일 하려고 할 때 컴파일 에러를 발생 시킨다.
        ...
        * 이러한 오류는 개발자가 미리 예측하여 처리하는 것이 불가능하며, 오류에 대한 처리는 할 수 있다.
        *
        * 예외(Exception)
        * 오류와 마찬가지로 실행 중인 프로그램을 비정상적으로 종료 시키지만
        * 발생할 수 있는 상황을 미리 예측하고 처리할 수 잇는 미약한 오류를 말한다.
