...
public class Application03 {
    public static void main(String[] args){
        ...
        *   2-4. 한글로 변수명을 짓는 것이 가능하지만 권자하지는 않는다. (한글을 취급하는 다양한 방식들이 존재하기 때문에 영어로 작성하는 것이 좋다.)
        *   2-5. 변수 안에 저장된 것이 어떤 의미를 가지는지를 명확하게 표현하도록 한다.
        ...
        * */
        ...
        //1-3 변수명은 대소문자를 구분한다
        int Age = 20;
        int True = 30;// 되지만 권장 X

        //1-4 변수명은 숫자로 시작할 수 없다.
        //int 1test = 10;
        int test1 = 10;

        // 1-5. 특수 기호는 '_'와 '$'만 사용 가능
        int _age = 10;
        int $test = 20;
        //int *test = 10;

        // 에러를 발생시키지는 않지만 개발자들 끼리의 규칙
        //int fjakjkskskkdkgkkgkkkdfkkdfkkfkkdkfkdfkkdfk;

        //2-2 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두번째 시작 단어는 대문자로 시작.
        // 자바에서는 클래스명만 유일하게 대문자로 시작한다.
        int MaxAge = 10; //이렇게 해도 무방하나 사용하지 않는다.
        ...
        // 2-8 booleen 형은 의문문은 가급적으로 긍정의 형태를 갖는다.
