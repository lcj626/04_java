...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        * 모든 코드를 우리가 다 외울 수 없기 때문에 api 문서를 별도로 제공해 주고 있다.
        * */
        ...
        * */
        ...
        System.out.println("-1.25의 절대값 : " + (Math.abs(-1.25))); //자바에서 기본적으로 제공하는 api라 굳이 import 해올 필요 없다.
        ...
        System.out.println("난수 발생 : " + (int)(Math.random()*10)); //if 0 안나오게 하고 싶음 (Math.random()*9)+1로 한다
