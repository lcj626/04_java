...
public class Application {
    ...
    public static void main(String[] args){
        ...
        *
        * 참고 '!' 는 앞으로 자주 사용하게 될 친구로 값을 boolean 결과 값을 부정한다.
        * */
        ...
        System.out.println("inum과 inum2가 같지 않은지 비교 : " + (inum1 != inum2));
        System.out.println("inum과 inum2보다 큰 지 비교 : " + (inum1 > inum2));
        System.out.println("inum과 inum2보다 크거나 같은지 비교 : " + (inum1 >= inum2));
        System.out.println("inum과 inum2보다 작은지 비교 : " + (inum1 < inum2));
        System.out.println("inum과 inum2보다 작거나 같은지 비교 : " + (inum1 <= inum2));
        ...
        String str1 = "java";
        //String str2 = "java";
        String str2 = new String( "java"); //일 시 서로 다른 것으로 인식

        System.out.println("============== 문자값 비교 ===============");
        System.out.println("str1과 str2가 같은지 비교 : " + (str1 == str2));
        System.out.println("str1과 str2가 같은지 비교 : " + (str2.equals(str1)));
